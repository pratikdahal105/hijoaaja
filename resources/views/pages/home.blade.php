            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <p class="font-weight-light">Some representative placeholder content for the first slide.</p>
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('assets/img/about.jpg')}}" class="d-block w-100" alt="...">
                        <p class="font-weight-light">Some representative placeholder content for the second slide.</p>
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('assets/img/home-bg.jpg')}}" class="d-block w-100" alt="...">
                        <p class="font-weight-light">Some representative placeholder content for the third slide.</p>
                    </div>
                </div>
